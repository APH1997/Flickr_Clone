...
def seed_users():
    demo = User(
        username='Demo', first_name='Demo', last_name='Lition', email='demo@aa.io', password='password', cover_photo_url='https://highrme-pics.s3.us-east-2.amazonaws.com/user-profile-banner.png')
    marnie = User(
