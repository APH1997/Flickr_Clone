...
class User(db.Model, UserMixin):
    ...
    profile_image_url = db.Column(db.String, nullable=True, default='https://highrme-pics.s3.us-east-2.amazonaws.com/default-user-profile-pic.jpeg')
